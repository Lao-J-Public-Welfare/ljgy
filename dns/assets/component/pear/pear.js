...
layui.config({
	...
	step:"step",		// 分布表单组件
	steps:"steps/steps",		// EasyWeb分布表单组件
	tag:"tag",			// 多标签页组件
	popup:"popup",      // 弹层封装
	...
	toast: "toast",         // 消息通知
	notices: "notices/notices",// EasyWeb消息通知
	...
	tagsInput:"tagsInput/tagsInput", //关键词组件
	dataGrid:"dataGrid",        //dataGrid组件
	Player:"Player",        //视频播放组件
	CircleProgress:"CircleProgress"        //圆形进度条组件
