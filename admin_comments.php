            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars(mb_substr($comment['content'], 0, 50)); ?>...</td>
                        <td><?php echo htmlspecialchars($comment['username']); ?></td>
                        <td><a href="post.php?id=<?php echo $comment['post_id']; ?>" class="post-link" target="_blank"><?php echo htmlspecialchars($comment['post_title']); ?></a></td>
                        <td><?php echo date('Y-m-d', strtotime($comment['created_at'])); ?></td>
                        <td>
                            <a href="?delete=<?php echo $comment['id']; ?>" class="btn" onclick="return confirm('确定删除该评论？')">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
