...
if ($resource === 'Information' && isset($segments[2]) && $segments[2] === 'personal' && isset($segments[3]) && $segments[3] === 'if') {
    require_once __DIR__ . '/Information/personal/if.php';
    exit;
}

$handlerMap = [
    'miacc' => __DIR__ . '/miacc/index.php',
    'deepseek' => __DIR__ . '/deepseek/index.php',
